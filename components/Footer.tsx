                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <div className="flex justify-center sm:justify-start space-x-4">
                            <a href="https://www.facebook.com/pqautos" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-light-text hover:text-secondary transition-colors bg-secondary/10 p-2 rounded-full hover:bg-secondary/20">
                                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                                </svg>
                            </a>
                            <a href="https://www.instagram.com/pqautos" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-light-text hover:text-secondary transition-colors bg-secondary/10 p-2 rounded-full hover:bg-secondary/20">
                                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            ...
                            <a href="https://twitter.com/pqautos" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="text-light-text hover:text-secondary transition-colors bg-secondary/10 p-2 rounded-full hover:bg-secondary/20">
                                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <ul className="space-y-3 text-light-text">
                            ...
                            <li className="flex items-start">
                                ...
                                <div className="font-bold">
                                    <p>General Inquiries: <a href="mailto:info@pqautos.com" className="hover:text-primary transition-colors">info@pqautos.com</a></p>
                                    <p className="mt-1">Sales Department: <a href="mailto:sales@pqautos.com" className="hover:text-primary transition-colors">sales@pqautos.com</a></p>
                                </div>
                            </li>
                        </ul>
                    </div>
