      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <AnimatedSection>
          <div className="max-w-3xl mx-auto mt-12 sm:mt-16 text-center">
            <h2 className="text-2xl sm:text-4xl font-black font-display text-secondary mb-8">
              Experience the PQ Autos Difference
            </h2>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link 
                to="/contact" 
                className="bg-primary text-white font-black font-display uppercase tracking-wider py-3 px-6 text-sm sm:text-base sm:py-4 sm:px-10 rounded-md shadow-xl transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:bg-primary-hover w-full sm:w-auto vibrant-shadow-red"
              >
                Schedule a Service
              </Link>
              <Link 
                to="/sales" 
                className="bg-secondary text-white font-black font-display uppercase tracking-wider py-3 px-6 text-sm sm:text-base sm:py-4 sm:px-10 rounded-md shadow-xl transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:bg-secondary-hover w-full sm:w-auto vibrant-shadow-blue"
              >
                View Our Cars
              </Link>
            </div>
